...
from schemas import (
    RecebimentosListSchema,
    TiposRecebimentosSchema,
    RecebimentosListResponseSchema
)
...
@receipt_router.get(
    ...
    response_model=RecebimentosListResponseSchema
)
async def listar_recebimentos(
    ...
    resposta = [
        RecebimentosListSchema(
            ...
            tipos=TiposRecebimentosSchema(**v["tipos"])
        )
        for v in lista_dias
    ]
    return RecebimentosListResponseSchema(
